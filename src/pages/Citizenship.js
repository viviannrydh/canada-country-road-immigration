        ...
        <div className="content-wrapper-service">
            <section >
                ...
                <ol>
                    ...
                    <li>已报税，在申请日期之前的5年内，在加拿大至少报税3年（如适用</li>
                    <li>通过入籍考试</li>
                    <li>证明你的语言能力</li>
                </ol>
                ...
                <ol>
                    ...
                    <li>现任或前加拿大武装部队成员在快速通道下的程序申请入籍</li>
            ...
            <section>
                ...
                <h3>什么时候延长学习许可</h3>
                <p>您的学习许可到期日期是您的学习许可将在许可上标明的日期
                或完成学习之日后的90天到期（以先到期者为准）。</p> 
                <ol>
                    <li>您应至少在许可证到期前30天申请延长许可证。确保您的护照不会同时过期。</li>
                ...
                <ol>
                    ...
                    <li>电子旅行授权书</li>
                    <li>一张有效的护照或旅行证件</li>
                    <li>如果你想延长你在加拿大的访客停留时间（在加拿大停留更长的时间），你需要申请一个访客记录。访客记录不是签证。</li>
                </ol>
            </section>
            <hr/>
            <section>
                <h3>访客记录</h3>
                <p>是一个让你访问加拿大的访客，让你停留更长时间的文件
                    包括一个新的到期日期
                    那是你必须离开加拿大的新日期
            ...
            <section>
                <h3>离开并返回加拿大</h3>
                <p>访问者记录是一种继续给你在加拿大的访问状态，让你停留更长的时间。
                这并不能保证你可以离开加拿大，然后再进入加拿大。
                如果你计划在加拿大或美国以外的地方旅行，你需要一份有效的入境证件，
                如游客签证或旅游签证，才能返回加拿大。</p>
            </section>
        </div>
    )
}
